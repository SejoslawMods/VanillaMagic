...
public class QuestAccelerant extends QuestAccelerationCrystal {
    public void fillTooltip(Collection<String> lines) {
        ...
        this.addLine(lines, "quest.tooltip.ticks", String.valueOf(VMForgeConfig.TILE_ACCELERANT_TICKS.get()));
        this.addLine(lines, "quest.tooltip.size", String.valueOf(VMForgeConfig.TILE_ACCELERANT_SIZE.get()));
        this.addLine(lines, "quest.tooltip.top", TextUtils.getFormattedText("quest.accelerant.desc.top"));
    }
}
