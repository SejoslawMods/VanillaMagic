...
import com.github.sejoslaw.vanillamagic2.common.spells.logics.SummonMeteorLogic;
...
public class SpellSummonMeteor extends Spell {
    public void cast(PlayerEntity player, World world, BlockPos pos, Direction face) {
        this.shootEntitySpell(world, player, (accelX, accelY, accelZ) -> new EntitySpell(EntityRegistry.SPELL.get(), world).withLogic(new SummonMeteorLogic()));
    }
}
