...
import com.github.sejoslaw.vanillamagic2.common.renderers.MeteorRenderer;
...
public class RenderingHandler extends EventHandler {
    ...
    public static void registerEntityRenderers(FMLClientSetupEvent event) {
        INSTANCE.registerRenderers(event, minecraft -> {
            ...
            RenderingRegistry.registerEntityRenderingHandler(EntityRegistry.METEOR.get(), MeteorRenderer::new);
        });
    }
}
