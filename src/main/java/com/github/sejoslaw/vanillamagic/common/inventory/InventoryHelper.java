...
public class InventoryHelper {
    ...
    public static boolean captureDroppedItems(IHopper hopper) {
        return HopperTileEntity.pullItems(hopper);
    }
     ...
     */
    public static boolean pullItemFromSlot(IInventory inventoryOut, IInventory inventoryIn, int index, Direction direction) {
        ...
        if (!ItemStackUtil.isNullStack(stack) && canExtractItemFromSlot(inventoryIn, stack, index, direction)) {
            ...
            ItemStack leftItems = putStackInInventoryAllSlots(inventoryOut, inventoryIn.decrStackSize(index, 1), (Direction) null);
    ...
    /**
     * Attempts to place the passed ItemEntity's stack into the inventory using as
    ...
    public static boolean putDropInInventoryAllSlots(IInventory inventoryIn, ItemEntity itemIn) {
        return HopperTileEntity.captureItem(inventoryIn, itemIn);
    }
     ...
     */
    public static List<ItemEntity> getCaptureItems(World world, double x, double y, double z) {
        return CauldronUtil.getItemsInCauldron(world, new BlockPos(x, y, z));
    }
    ...
    public static IInventory getInventoryAtPosition(World worldIn, double x, double y, double z) {
        return HopperTileEntity.getInventoryAtPosition(worldIn, x, y, z);
    }
