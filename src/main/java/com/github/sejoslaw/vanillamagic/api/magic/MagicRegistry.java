...
public class MagicRegistry {
     ...
     * SpellRegistry.class
     */
    public static final String SPELL_REGISTRY = "com.github.sejoslaw.vanillamagic.magic.spell.SpellRegistry";
    /**
     * WandRegistry.class
     */
    public static final String WAND_REGISTRY = "com.github.sejoslaw.vanillamagic.magic.wand.WandRegistry";
    /**
     * EvokerSpellRegistry.class
     */
    public static final String EVOKER_REGISTRY = "com.github.sejoslaw.vanillamagic.item.evokercrystal.EvokerSpellRegistry";
    ...
    public static IWand isWandInMainHand(PlayerEntity player) {
        try {
            ...
            Method m = wandRegistryClass.getMethod("isWandInMainHand", PlayerEntity.class);
    ...
    public static IWand isWandInOffHand(PlayerEntity player) {
        try {
            Class<?> wandRegistryClass = Class.forName(WAND_REGISTRY);
            Method m = wandRegistryClass.getMethod("isWandInOffHand", PlayerEntity.class);
            return (IWand) m.invoke(null, player);
        } catch (Exception e) {
