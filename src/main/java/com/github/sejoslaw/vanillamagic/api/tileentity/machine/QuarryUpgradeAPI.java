...
/**
 * This is the connection to VanillaMagic's QuarryUpgrade module.
 *
...
public class QuarryUpgradeAPI {
     ...
     */
    private static final String REGISTRY_CLASS = "com.github.sejoslaw.vanillamagic.tileentity.machine.quarry.QuarryUpgradeRegistry";
     ...
     * @throws MappingExistsException this {@link Exception} will be thrown if there
     *                                is already registered upgrade with this Block
     *                                (solve: change this Upgrade's Block in
     *                                "getBlock" method)
     */
    ...
    /**
     * @return Returns TRUE if the given block is an Block connected to any
     * IQuarryUpgrade
     */
    ...
    /**
     * @return Returns the QuarryUpgrade from given Block if the Upgrade is
