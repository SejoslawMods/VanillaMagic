 ...
 */
public class EventCustomItem extends VMEvent {
	...
	public static class OnUseByPlayer extends EventCustomItem {
		...
		public OnUseByPlayer(ICustomItem usedItem, PlayerEntity user, World world, BlockPos usedOnPos) {
			super(usedItem);
			this.user = user;
			this.world = world;
		...
		public static class OnTileEntity extends OnUseByPlayer {
			...
			public OnTileEntity(ICustomItem usedItem, PlayerEntity user, World world, BlockPos usedOnPos, TileEntity tile) {
