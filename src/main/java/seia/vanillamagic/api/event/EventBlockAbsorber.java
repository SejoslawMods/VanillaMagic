...
public class EventBlockAbsorber extends EventCustomTileEntity {
	...
	private final TileEntityHopper connectedHopper;

	public EventBlockAbsorber(IBlockAbsorber tileAbsorber, World world, BlockPos tilePos,
			TileEntityHopper connectedHopper) {
