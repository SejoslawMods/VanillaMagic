...
public interface ICustomTileEntity
		extends ITickable, IAdditionalInfoProvider, INBTSerializable<NBTTagCompound>, ITileEntityWrapper {
	/**
	...
	/**
	 * @return Returns the tag compound which is used to update this
	 *         CustomTileEntity.
	 */
