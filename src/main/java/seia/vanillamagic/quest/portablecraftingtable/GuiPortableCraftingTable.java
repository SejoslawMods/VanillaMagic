...
/**
 * Class which represents GUI for Portable Crafting Table (PCT). Similar to
...
public class GuiPortableCraftingTable extends GuiContainer {
	public static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES = new ResourceLocation(
