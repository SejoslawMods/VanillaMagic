...
public class AltarUtil 
{
	...
	{
		if  (tier == 1) return BLOCK_TIER_1;
		else if  (tier == 2) return BLOCK_TIER_2;
		else if  (tier == 3) return BLOCK_TIER_3;
		else if  (tier == 4) return BLOCK_TIER_4;
		else if  (tier == 5) return BLOCK_TIER_5;
		else if  (tier == 6) return BLOCK_TIER_6;
		else if  (tier == 7) return BLOCK_TIER_7;
		return null;
	}
	
	public static boolean checkAltarTier(World world, BlockPos midPos, int tier)
	{
		if  (tier == 1) return checkTier1(world, midPos);
		else if  (tier == 2) return checkTier2(world, midPos);
		else if  (tier == 3) return checkTier3(world, midPos);
		else if  (tier == 4) return checkTier4(world, midPos);
		else if  (tier == 5) return checkTier5(world, midPos);
		else if  (tier == 6) return checkTier6(world, midPos);
		else if  (tier == 7) return checkTier7(world, midPos);
		return false;
	}
	...
	public static boolean checkTier1(World world, BlockPos midPos)
	{
		...
		if (Block.isEqualTo(world.getBlockState(right).getBlock(), BLOCK_TIER_1))
			if (Block.isEqualTo(world.getBlockState(rightUp).getBlock(), BLOCK_TIER_1))
				if (Block.isEqualTo(world.getBlockState(up).getBlock(), BLOCK_TIER_1))
					if (Block.isEqualTo(world.getBlockState(leftUp).getBlock(), BLOCK_TIER_1))
						if (Block.isEqualTo(world.getBlockState(left).getBlock(), BLOCK_TIER_1))
							if (Block.isEqualTo(world.getBlockState(leftDown).getBlock(), BLOCK_TIER_1))
								if (Block.isEqualTo(world.getBlockState(down).getBlock(), BLOCK_TIER_1))
									if (Block.isEqualTo(world.getBlockState(rightDown).getBlock(), BLOCK_TIER_1))
										return true;
		return false;
	}
	...
	{
		if (checkTier1(world, midPos)) return checkTier2Only(world, midPos);
		return false;
	}
	...
	{
		if (checkTier2(world, midPos)) return checkTier3Only(world, midPos);
		return false;
	}
	...
	{
		if (checkTier3(world, midPos)) return checkTier4Only(world, midPos);
		return false;
	}
	...
	{
		if (checkTier4(world, midPos)) return checkTier5Only(world, midPos);
		return false;
	}
	...
	{
		if (checkTier5(world, midPos)) return checkTier6Only(world, midPos);
		return false;
	}
	...
	{
		if (checkTier6(world, midPos)) return checkTier7Only(world, midPos);
		return false;
	}
