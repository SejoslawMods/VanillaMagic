...
public class EntitySpell extends Entity {
	...
	public EntitySpell(World world, EntityLivingBase caster, double accelX, double accelY, double accelZ) {
		super(world);

		this.castingEntity = caster;
		this.setSize(1.0F, 1.0F);
		this.setLocationAndAngles(caster.posX + accelX, // in front of face = accelX
	...
	public void onUpdate() {
		if (this.world.isRemote || (this.castingEntity == null || !this.castingEntity.isDead)
	...
	/**
	 * Run when this Entity is in water. (Spawn water particle, etc.)
	 */
	public void inWater() {
	}
