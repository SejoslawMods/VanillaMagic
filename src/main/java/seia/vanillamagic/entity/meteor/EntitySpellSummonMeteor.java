...
public class EntitySpellSummonMeteor extends EntitySpellUpdate {
	public EntitySpellSummonMeteor(World world, EntityLivingBase caster, double accelX, double accelY, double accelZ) {
	...
	public void onImpact(RayTraceResult result) {
		...
		// Meteor spawning
		EntityMeteor meteor = new EntityMeteor(this.castingEntity, spawnMeteorX, spawnMeteorY, spawnMeteorZ,
