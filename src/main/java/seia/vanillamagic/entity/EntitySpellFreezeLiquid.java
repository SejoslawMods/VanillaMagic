...
public class EntitySpellFreezeLiquid extends EntitySpell {
	...
	public EntitySpellFreezeLiquid(World world, EntityLivingBase caster, double accelX, double accelY, double accelZ,
	...
	public void inWater() {
		if (circleCenter == null) {
			...
			circleCenter = new BlockPos(this.posX - casterLookVec.getX(), this.posY - casterLookVec.getY(),
					this.posZ - casterLookVec.getZ());
			List<BlockPos> blockPosToReplace = BlockPosUtil.getBlockPos3x3XZAroundCenterWithCenter(circleCenter.getX(),
					circleCenter.getY(), circleCenter.getZ());
