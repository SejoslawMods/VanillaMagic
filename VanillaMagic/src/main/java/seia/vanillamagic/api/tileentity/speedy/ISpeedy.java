...
public interface ISpeedy extends ICustomTileEntity
{
	...
	/**
	 * @return Returns the {@link IInventoryWrapper} for the {@link IInventory} with Acceleration Crystal.
	 */
	IInventoryWrapper getInventoryWithCrystal();
	
	/**
	 * @return Returns TRUE if the connected {@link IInventory} contains Acceleration Crystal.
	 */
