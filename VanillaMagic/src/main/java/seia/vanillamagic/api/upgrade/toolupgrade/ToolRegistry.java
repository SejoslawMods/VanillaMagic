...
public class ToolRegistry 
{
	...
	{
		return _ENTRYS.get(index).toolIn;
	}
	...
	{
		return _ENTRYS.get(index).ingredient;
	}
	...
	{
		return _ENTRYS.get(index).toolOut;
	}
	...
	/**
	 * @param base
	 * @return Returns the ingredient connected with given base Tool. NULL if given Tool has no crafting.
	 */
	@Nullable
	 ...
	 * @param base
	 * @param ingredient
	 * @return Returns the registered result based on given base Tool and ingredient. NULL if there is no result for given arguments.
	 */
	@Nullable
