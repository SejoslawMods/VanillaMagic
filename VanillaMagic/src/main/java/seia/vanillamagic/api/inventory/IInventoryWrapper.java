...
/**
 * This interface is used to hold all the basic information about a single {@link IInventory} on {@link World}.
 */
public interface IInventoryWrapper
{
	 ...
	 * 
	 * @throws NotInventoryException thrown if the {@link TileEntity} at given {@link BlockPos} can't be cast to {@link IInventory}
	 */
