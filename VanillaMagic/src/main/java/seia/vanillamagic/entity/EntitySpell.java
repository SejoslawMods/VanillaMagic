...
public abstract class EntitySpell extends Entity
{
	...
	public void onUpdate()
	{
		if (this.world.isRemote || (this.castingEntity == null || !this.castingEntity.isDead) && this.world.isBlockLoaded(new BlockPos(this)))
		{
			...
			if (this._inGround)
			{
				...
				{
					++this._ticksAlive;
					if (this._ticksAlive == 600) this.setDead();
					return;
				}
			...
			if (rayTraceResult != null) this.onImpact(rayTraceResult);
	...
	public void readEntityFromNBT(NBTTagCompound compound)
	{
		...
		if (compound.hasKey("inTile", 8)) this._inTile = Block.getBlockFromName(compound.getString("inTile"));
		else this._inTile = Block.getBlockById(compound.getByte("inTile") & 255);
