...
public class QuestList 
{
	...
	public static final QuestCraftOnAltar QUEST_CRAFT_COBBLESTONE = new QuestCraftOnAltar(QUEST_CRAFT_DIRT.getAchievement(), 
			QUEST_CRAFT_DIRT.getPosX() - 2, 
			QUEST_CRAFT_DIRT.getPosY(),  
			"Craft Cobblestone", 
			"craftCobblestone", 
	...
	public static final QuestCraftOnAltar QUEST_CRAFT_CACTUS = new QuestCraftOnAltar(QUEST_BUILD_ALTAR_TIER_2.getAchievement(), 
			...
			2,
			EnumWand.STICK);
	public static final QuestCraftOnAltar QUEST_CRAFT_SAPLING = new QuestCraftOnAltar(QUEST_CRAFT_CACTUS.getAchievement(), 
			QUEST_CRAFT_CACTUS.getPosX() - 2, 
			QUEST_CRAFT_CACTUS.getPosY(), 
			...
			2, 
			EnumWand.STICK);
	public static final QuestCraftOnAltar QUEST_CRAFT_PUMPKIN = new QuestCraftOnAltar(QUEST_CRAFT_SAPLING.getAchievement(), 
			QUEST_CRAFT_SAPLING.getPosX() - 2, 
			QUEST_CRAFT_SAPLING.getPosY(), 
			...
			2, 
			EnumWand.STICK);
	public static final QuestCraftOnAltar QUEST_CRAFT_MELON = new QuestCraftOnAltar(QUEST_CRAFT_PUMPKIN.getAchievement(), 
			QUEST_CRAFT_PUMPKIN.getPosX() - 2, 
			QUEST_CRAFT_PUMPKIN.getPosY(), 
			...
			2, 
			EnumWand.STICK);
	public static final QuestCraftOnAltar QUEST_CRAFT_VINES = new QuestCraftOnAltar(QUEST_CRAFT_MELON.getAchievement(), 
			QUEST_CRAFT_MELON.getPosX() - 2, 
			QUEST_CRAFT_MELON.getPosY(), 
			Item.getItemFromBlock(Blocks.VINE), 
			"Craft Vine", 
			"craftVine", 
			...
			2, 
			EnumWand.STICK);
	public static final QuestCraftOnAltar QUEST_CRAFT_LILY_PAD = new QuestCraftOnAltar(QUEST_CRAFT_VINES.getAchievement(), 
			QUEST_CRAFT_VINES.getPosX() - 2, 
			QUEST_CRAFT_VINES.getPosY(), 
			Item.getItemFromBlock(Blocks.WATERLILY), 
			"Craft Lily Pad", 
			"craftLiyPad", 
	...
	public static final QuestQuarry QUEST_QUARRY = new QuestQuarry(QUEST_SMELT_ON_ALTAR.getAchievement(), 
			QUEST_SMELT_ON_ALTAR.getPosX(), 
			QUEST_SMELT_ON_ALTAR.getPosY() + 2, 
			"Quarry !!!", 
			"quarry");
	...
	public static final QuestCraftOnAltar QUEST_CRAFT_ARROW = new QuestCraftOnAltar(QUEST_CRAFT_BONE.getAchievement(), 
			...
			4,
			EnumWand.STICK);
	public static final QuestArrowMachineGun QUEST_ARROW_MACHINE_GUN = new QuestArrowMachineGun(QUEST_CRAFT_ARROW.getAchievement(), 
			QUEST_CRAFT_ARROW.getPosX(), 
			QUEST_CRAFT_ARROW.getPosY() - 2, 
			Items.ARROW, 
			"Arrow Machine Gun", 
			"arrowMachineGun");
	...
	public static final QuestBuildAltar QUEST_BUILD_ALTAR_TIER_7 = new QuestBuildAltar(QUEST_BUILD_ALTAR_TIER_6.getAchievement(), 
			...
			"buildAltarTier7", 
			7);
	public static final QuestCraftOnAltar QUEST_CRAFT_GOLD_ORE = new QuestCraftOnAltar(QUEST_BUILD_ALTAR_TIER_7.getAchievement(), 
			...
			7, 
			EnumWand.BLAZE_ROD);
	public static final QuestCraftOnAltar QUEST_CRAFT_COAL_ORE = new QuestCraftOnAltar(QUEST_CRAFT_GOLD_ORE.getAchievement(), 
			QUEST_CRAFT_GOLD_ORE.getPosX(), 
			QUEST_CRAFT_GOLD_ORE.getPosY() + 2, 
			Item.getItemFromBlock(Blocks.COAL_ORE), 
			"Craft Coal Ore", 
			"craftCoalOre", 
			new ItemStack[]{new ItemStack(Blocks.GOLD_ORE)}, 
			new ItemStack(Blocks.COAL_ORE, 4), 
			7,
			EnumWand.BLAZE_ROD);
	public static final QuestCraftOnAltar QUEST_CRAFT_REDSTONE_ORE = new QuestCraftOnAltar(QUEST_CRAFT_GOLD_ORE.getAchievement(), 
			QUEST_CRAFT_GOLD_ORE.getPosX() - 2, 
			QUEST_CRAFT_GOLD_ORE.getPosY(), 
			...
			7,
			EnumWand.BLAZE_ROD);
	public static final QuestCraftOnAltar QUEST_CRAFT_LAPIS_ORE = new QuestCraftOnAltar(QUEST_CRAFT_REDSTONE_ORE.getAchievement(), 
			QUEST_CRAFT_REDSTONE_ORE.getPosX() - 2, 
			QUEST_CRAFT_REDSTONE_ORE.getPosY(), 
			...
			7,
			EnumWand.BLAZE_ROD);
	public static final QuestCraftOnAltar QUEST_CRAFT_DIAMOND_ORE = new QuestCraftOnAltar(QUEST_CRAFT_LAPIS_ORE.getAchievement(), 
			QUEST_CRAFT_LAPIS_ORE.getPosX() - 2, 
			QUEST_CRAFT_LAPIS_ORE.getPosY(), 
	...
	public static final QuestCraftOnAltar QUEST_CRAFT_EMERALD = new QuestCraftOnAltar(QUEST_BUILD_ALTAR_TIER_7.getAchievement(), 
			...
			7,
			EnumWand.BLAZE_ROD);
	public static final QuestCraftOnAltar QUEST_CRAFT_EMERALD_ORE = new QuestCraftOnAltar(QUEST_CRAFT_EMERALD.getAchievement(), 
			QUEST_CRAFT_EMERALD.getPosX(), 
			QUEST_CRAFT_EMERALD.getPosY() + 2, 
